...
resource "aws_opsworks_custom_layer" "vts-app-layer" {
  name       = "${var.env}-vts-server-layer"
  short_name = "vts-${var.app-layer-shortname}"
  stack_id   = "${aws_opsworks_stack.stack.id}"
  auto_healing = "${var.autoheal}"
  custom_security_group_ids = ["${var.ops_vts_sg}"]
  custom_setup_recipes = "${var.vts_setup_recipes}"
  custom_configure_recipes = "${var.vts_config_recipes}"
  custom_shutdown_recipes = "${var.vts_shutdown_recipes}"
  custom_json = "${var.vts_custom_json}"
  #auto_assign_public_ips = "${var.auto_public_ips}"
  auto_assign_elastic_ips = "${var.auto_elastic_ips}"
}
